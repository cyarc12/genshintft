...
tickAmberBombs=function(dt){
  for(const b of amberBombs){
    b.time+=dt;if(b.resolved||b.time<b.explodeAt)continue;b.resolved=true;
    const flat=confirmedValue(b.source,[300,400,2000]);
    const ratio=confirmedValue(b.source,[2,3,1]);
...
Object.assign(SKILL_INFO,{
  ...
  '安柏':'初始法力40/120。\\n【R·爆弹玩偶】优先在能够覆盖当前攻击目标的位置中选择敌人最密集的落点；没有合法落点时选择全棋盘最密集位置。延迟1秒后对半径1.5格敌人造成300/400/2000 + 攻击力200%/300%/100%的火元素伤害，全部附着。',
